...
\begin{wraptable}{r}{0.45\textwidth}
    ...
    \begin{tabular}{lccc}
        ...
        \midrule
        \rev{RDMA} & \rev{\textbf{0.66}} & \rev{0.64} & \rev{0.67} \\
