...
%% ============================================================
\section*{Bootstrapped Confidence Intervals}\label{appdx: CIs}
Because reruns are prohibitively expensive, we minimize LLM temperature (i.e t=0.001) to limit variance. However, we still include bootstrapped confidence intervals (Supplementary Tables~\sTabPhenoCI{} and~\sTabRareCI).
% Requires: \usepackage{booktabs}
% ± symbol: compile with pdflatex or xelatex
