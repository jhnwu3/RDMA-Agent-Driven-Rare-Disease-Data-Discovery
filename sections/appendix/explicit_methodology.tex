\section{Explicit Methodology} \label{appendix: exp method}
...
Both the sentence and these candidates are incorporated into our prompting strategy as illustrated in Appendix \ref{appendix:prompts}. Our objective is to extract from each document $x_i$ sets of potentially relevant entities related to phenotypes or rare diseases, which we denote as:
\begin{align}
