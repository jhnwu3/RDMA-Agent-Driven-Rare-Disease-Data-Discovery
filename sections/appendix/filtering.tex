\section*{MIMIC3-RD Preliminary Filtering}
\textbf{Preliminary Filtering.} Before applying our RDMA refinement (Supplementary Fig.~\sFigExAnnotation{}), we filter out known incorrect keywords and add known rare disease mentions, as detailed in Supplementary Table~\sTabFilterDetails. These changes significantly impact the dataset statistics (Supplementary Table~\sTabFilterResults), reducing annotations from 1,073 to 333. We use this filtered dataset for our case study in the main manuscript.
...
\hline
\end{tabular}
\caption{\textbf{Rare Disease Annotation Statistics Before and After Initial Keyword Filtering.} We eliminated over 700 misannotated terms before conducting evaluations in the main manuscript.}
