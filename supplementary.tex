...
\usepackage[numbers]{natbib}% provides \citeauthoryear used by sn-mathphys-num.bst
\usepackage{hyperref}
% sn-mathphys-num.bst emits a few sn-jnl-class macros; neutralise them under article class.
